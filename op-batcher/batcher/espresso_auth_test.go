...
// submitAuthenticatedBatch onto the serialized blob path. That path is unreachable
// in production while calldata-only DA is enforced; its tests are kept so it stays
// covered if the restriction is lifted.

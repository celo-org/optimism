...
contract OptimismPortal2WithMockERC20_Test is OptimismPortal2_FinalizeWithdrawalTransaction_Test {
    MockERC20 token;
    ...
    function test_depositTransaction_customGasTokenWithValue_reverts() external {
        ...
        vm.expectRevert(IOptimismPortal.OptimismPortal_NoValue.selector);
    ...
    function test_depositERC20Transaction_incorrectTokenBalance_reverts() external {
        ...
        vm.expectRevert(IOptimismPortal.OptimismPortal_TransferFailed.selector);
    ...
    function test_depositERC20Transaction_noCustomGasToken_reverts() external {
        ...
        (address token_,) = systemConfig.gasPayingToken();
        assertEq(token_, Constants.ETHER);

        vm.expectRevert(IOptimismPortal.OnlyCustomGasToken.selector);
        optimismPortal2.depositERC20Transaction(address(0), 0, 0, 0, false, "");
    }
}

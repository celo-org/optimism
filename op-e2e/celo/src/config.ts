...
export function erc20PublicActions(client: any) {
  return {
    ...
    getERC20Symbol: (args: Parameters<typeof getERC20Symbol>[1]) =>
      getERC20Symbol(client, args),
    getERC20BalanceOf: (args: Parameters<typeof getERC20BalanceOf>[1]) =>
      getERC20BalanceOf(client, args),
    getERC20Decimals: (args: Parameters<typeof getERC20Decimals>[1]) =>

...
// DELAYEDWETHSLOT is a free data retrieval call binding the contract method 0x7e54b8ad.
//
// Solidity: function DELAYED_WETH_SLOT() view returns(bytes32)
func (_SystemConfig *SystemConfigCaller) DELAYEDWETHSLOT(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _SystemConfig.contract.Call(opts, &out, "DELAYED_WETH_SLOT")
...
//
// Solidity: function DELAYED_WETH_SLOT() view returns(bytes32)
func (_SystemConfig *SystemConfigSession) DELAYEDWETHSLOT() ([32]byte, error) {
	return _SystemConfig.Contract.DELAYEDWETHSLOT(&_SystemConfig.CallOpts)
}

// DELAYEDWETHSLOT is a free data retrieval call binding the contract method 0x7e54b8ad.
//
// Solidity: function DELAYED_WETH_SLOT() view returns(bytes32)
func (_SystemConfig *SystemConfigCallerSession) DELAYEDWETHSLOT() ([32]byte, error) {
	return _SystemConfig.Contract.DELAYEDWETHSLOT(&_SystemConfig.CallOpts)
}
...
// OPCMSLOT is a free data retrieval call binding the contract method 0x2efe2c63.
//
// Solidity: function OPCM_SLOT() view returns(bytes32)
func (_SystemConfig *SystemConfigCaller) OPCMSLOT(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _SystemConfig.contract.Call(opts, &out, "OPCM_SLOT")
...
//
// Solidity: function OPCM_SLOT() view returns(bytes32)
func (_SystemConfig *SystemConfigSession) OPCMSLOT() ([32]byte, error) {
	return _SystemConfig.Contract.OPCMSLOT(&_SystemConfig.CallOpts)
}

// OPCMSLOT is a free data retrieval call binding the contract method 0x2efe2c63.
//
// Solidity: function OPCM_SLOT() view returns(bytes32)
func (_SystemConfig *SystemConfigCallerSession) OPCMSLOT() ([32]byte, error) {
	return _SystemConfig.Contract.OPCMSLOT(&_SystemConfig.CallOpts)
}
...
// DelayedWETH is a free data retrieval call binding the contract method 0x215b7a1c.
//
// Solidity: function delayedWETH() view returns(address addr_)
func (_SystemConfig *SystemConfigCaller) DelayedWETH(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SystemConfig.contract.Call(opts, &out, "delayedWETH")
...
//
// Solidity: function delayedWETH() view returns(address addr_)
func (_SystemConfig *SystemConfigSession) DelayedWETH() (common.Address, error) {
	return _SystemConfig.Contract.DelayedWETH(&_SystemConfig.CallOpts)
}

// DelayedWETH is a free data retrieval call binding the contract method 0x215b7a1c.
//
// Solidity: function delayedWETH() view returns(address addr_)
func (_SystemConfig *SystemConfigCallerSession) DelayedWETH() (common.Address, error) {
	return _SystemConfig.Contract.DelayedWETH(&_SystemConfig.CallOpts)
}
...
//
// Solidity: function getAddresses() view returns((address,address,address,address,address,address,address))
...
// LastUsedOPCM is a free data retrieval call binding the contract method 0x8ed95502.
//
// Solidity: function lastUsedOPCM() view returns(address addr_)
func (_SystemConfig *SystemConfigCaller) LastUsedOPCM(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SystemConfig.contract.Call(opts, &out, "lastUsedOPCM")
...
//
// Solidity: function lastUsedOPCM() view returns(address addr_)
func (_SystemConfig *SystemConfigSession) LastUsedOPCM() (common.Address, error) {
	return _SystemConfig.Contract.LastUsedOPCM(&_SystemConfig.CallOpts)
}

// LastUsedOPCM is a free data retrieval call binding the contract method 0x8ed95502.
//
// Solidity: function lastUsedOPCM() view returns(address addr_)
func (_SystemConfig *SystemConfigCallerSession) LastUsedOPCM() (common.Address, error) {
	return _SystemConfig.Contract.LastUsedOPCM(&_SystemConfig.CallOpts)
}

// LastUsedOPCMVersion is a free data retrieval call binding the contract method 0x9fabcc84.
//
// Solidity: function lastUsedOPCMVersion() view returns(string version_)
func (_SystemConfig *SystemConfigCaller) LastUsedOPCMVersion(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _SystemConfig.contract.Call(opts, &out, "lastUsedOPCMVersion")
...
//
// Solidity: function lastUsedOPCMVersion() view returns(string version_)
func (_SystemConfig *SystemConfigSession) LastUsedOPCMVersion() (string, error) {
	return _SystemConfig.Contract.LastUsedOPCMVersion(&_SystemConfig.CallOpts)
}

// LastUsedOPCMVersion is a free data retrieval call binding the contract method 0x9fabcc84.
//
// Solidity: function lastUsedOPCMVersion() view returns(string version_)
func (_SystemConfig *SystemConfigCallerSession) LastUsedOPCMVersion() (string, error) {
	return _SystemConfig.Contract.LastUsedOPCMVersion(&_SystemConfig.CallOpts)
}
...
// Initialize is a paid mutator transaction binding the contract method 0x2b598b8a.
//
// Solidity: function initialize(address _owner, uint32 _basefeeScalar, uint32 _blobbasefeeScalar, bytes32 _batcherHash, uint64 _gasLimit, address _unsafeBlockSigner, (uint32,uint8,uint8,uint32,uint32,uint128) _config, address _batchInbox, (address,address,address,address,address,address,address) _addresses, uint256 _l2ChainId, address _superchainConfig) returns()
...
// SetBatcherHash is a paid mutator transaction binding the contract method 0x0a2ca2a9.
//
// Solidity: function setBatcherHash(address _batcher) returns()
func (_SystemConfig *SystemConfigTransactor) SetBatcherHash(opts *bind.TransactOpts, _batcher common.Address) (*types.Transaction, error) {
	return _SystemConfig.contract.Transact(opts, "setBatcherHash", _batcher)
}

// SetBatcherHash is a paid mutator transaction binding the contract method 0x0a2ca2a9.
//
// Solidity: function setBatcherHash(address _batcher) returns()
func (_SystemConfig *SystemConfigSession) SetBatcherHash(_batcher common.Address) (*types.Transaction, error) {
	return _SystemConfig.Contract.SetBatcherHash(&_SystemConfig.TransactOpts, _batcher)
}

// SetBatcherHash is a paid mutator transaction binding the contract method 0x0a2ca2a9.
//
// Solidity: function setBatcherHash(address _batcher) returns()
func (_SystemConfig *SystemConfigTransactorSession) SetBatcherHash(_batcher common.Address) (*types.Transaction, error) {
	return _SystemConfig.Contract.SetBatcherHash(&_SystemConfig.TransactOpts, _batcher)
}

// SetBatcherHash0 is a paid mutator transaction binding the contract method 0xc9b26f61.
//
// Solidity: function setBatcherHash(bytes32 _batcherHash) returns()
func (_SystemConfig *SystemConfigTransactor) SetBatcherHash0(opts *bind.TransactOpts, _batcherHash [32]byte) (*types.Transaction, error) {
	return _SystemConfig.contract.Transact(opts, "setBatcherHash0", _batcherHash)
}

// SetBatcherHash0 is a paid mutator transaction binding the contract method 0xc9b26f61.
//
// Solidity: function setBatcherHash(bytes32 _batcherHash) returns()
func (_SystemConfig *SystemConfigSession) SetBatcherHash0(_batcherHash [32]byte) (*types.Transaction, error) {
	return _SystemConfig.Contract.SetBatcherHash0(&_SystemConfig.TransactOpts, _batcherHash)
}

// SetBatcherHash0 is a paid mutator transaction binding the contract method 0xc9b26f61.
//
// Solidity: function setBatcherHash(bytes32 _batcherHash) returns()
func (_SystemConfig *SystemConfigTransactorSession) SetBatcherHash0(_batcherHash [32]byte) (*types.Transaction, error) {
	return _SystemConfig.Contract.SetBatcherHash0(&_SystemConfig.TransactOpts, _batcherHash)
}
